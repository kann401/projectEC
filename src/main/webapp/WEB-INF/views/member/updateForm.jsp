...
<c:if test="${errorMsg != null}"> alertify.alert('${errorMsg}');
</c:if>
...
function formCheck() {
   ...
   if (id.value.length < 3 || id.value.length > 13) {
	  alertify.alert("Please input ID to 3 to 13 characters.");
      id.focus();
      id.select();
      return false;
   }
   if (pw.value.length < 3 || pw.value.length > 10) {
	  alertify.alert("Please input PASSWORD to 3 to 10 characters.");
      pw.focus();
      pw.select();
      return false;
   }
   if (pw.value != pw2.value) {
	   alertify.alert("Please enter your PASSWORD accurately.");
      pw.focus();
      pw.select();
      return false;
   }
						...
						<div class="example-box-wrapper">
							<form id="updateform" action="update"
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="custname" name="custname" value="${member.name}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="name" name="name" value="${member.custname}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="custtel" name="custtel" value="${member.custtel}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										...
										<span class="input-group-btn">
											<button
												...
												type="button" onclick="sample4_execDaumPostcode()">Postcode</button>
										</span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="sample4_roadAddress" name="road" value="${member.road}">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">COMPANY <br>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="idno" name="idno" readonly="readonly"
											value="${member.idno}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<label class="radio-inline"> <input type="radio"
											name="division" value="cafe" onfocus="setRadioCl(event)"
											<c:if test="${member.division == 'cafe'}">checked</c:if> />
											CAFE
										</label> <label class="radio-inline"> <input type="radio"
											name="division" value="business" onfocus="setRadioCl(event)"
											<c:if test="${member.division == 'business'}">checked</c:if> />
											PICKUP COMPANY
										</label>
									</div>
								</div>
								...
								<div class="form-group" style="display: none;">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="lat" name="lat" value="${member.lat}">
									</div>
									<br>
									<br> <label class="col-sm-3 control-label">Lng</label>
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="lng" name="lng" value="${member.lng}">
									</div>
								...
								<div class="form-group">
									<div>
										<button type="submit"
											class="btn btn-default btn-lg btn-block btn-border border-green btn-block">UPDATE</button>
										<button type="button"
											class="btn btn-default btn-lg btn-block btn-border border-green btn-block"
											onclick="location.href='<%=cp%>/member/myPage'">BACK</button>
									</div>
								</div>
							</form>
						</div>
