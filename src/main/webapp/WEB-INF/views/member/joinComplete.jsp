...
<!-- QR Code -->
<script type="text/javascript"
	src="../resources/js/jquery.qrcode.min.js"></script>
...
<body>
							...
							<form class="form-horizontal bordered-row" id="demo-form">
								...
								<div class="bg-default content-box text-center pad20A mrg25T">
									<button type="button" class="btn btn-lg btn-primary"
										onclick="location.href='<%=gc%>/member/login'">LOGIN</button>
								</div>
							</form>
						</div>
					</div>
	...
	<script type="text/javascript">
		var id = $("#qrId").val();
		var a = "http://10.10.8.18:8888/projectEC/qrForm/collectform1?cafeid="
				+ id;
		...
		jQuery(function() {
					...
					.qrcode(
							{
								...
								width : 200,
								height : 200,
								text : "http://10.10.8.18:8888/projectEC/qrForm/collectform1?cafeid="+ id
							});
			...
			var canvas3 = document.querySelector("#qrcodeCanvas canvas");
			var qrImage = canvas3.toDataURL("image/png");
			//alert(qrImage);
			$.ajax({
				url : "setQRImage",
				method : "post",
				...
				success : function(result) {
					alertify.alert("Welcome to ECO COFFEE!");
				},
				error : function(x) {
