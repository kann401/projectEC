...
<title>ECO COFFEE - MY PAGE</title>
...
<script>
	function callFunction() {
		window.open("printForm", "newwin",
				"top=100,left=400,width=700,height=550,resizable=no");
	}
</script>
...
<body>
	...
	<div align="center" style="background: white;">
		<div class="row" style="background: white;">
			<div style="width: 1170px; background: white;">
				...
				<c:if test="${count>10}">
            		<div id="page-title">
               			<h3 class="p-title">
                  			<span><img src="../resources/image/bmark.jpg"
                    			 style="width: 4%;">&nbsp;MY PAGE</span>
               			</h3>
           			</div>
            	</c:if>
							...
							<form class="form-horizontal bordered-row" id="demo-form">
								<div class="row">
									...
									<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" id="qrId" value="${member.custid}"
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.custname}"
													readonly="readonly" required class="form-control">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.custtel}"
													readonly="readonly" required class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.tel}" readonly="readonly"
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.postcode}"
													readonly="readonly" required class="form-control">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.road}"
													readonly="readonly" required class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.jibun}"
													readonly="readonly" required class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="${member.idno}"
													readonly="readonly" required class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<div class="checkbox">
													<input type="text" value="${member.division}"
														readonly="readonly" required class="form-control">
												</div>
											</div>
										</div>
											...
											<div class="col-sm-6">
												<div class="checkbox">
													<div style="float: center; margin-right: 10px;">
														<img src="showQR?custid=${member.custid}" />
													</div>
												</div>
											</div>
										</div>
								...
								<div class="bg-default content-box text-center pad20A mrg25T">
									<a
										href="https://drive.google.com/open?id=0BzBqMEgWlutIRGU0dUhGY1hqTkk"
										target="_blank" class="bs-label label-success">CLICK HERE
										: QR CODE ANDROID APPLICATION</a>
								</div>
								<div class="bg-default content-box text-center pad20A mrg25T">
								
									<c:if test="${count>10}">
                           				<button type="button" class="btn btn-lg btn-primary"
                              				onclick="callFunction();return false;">ECO MARK</button>
                          			</c:if>
										
									<button type="button" class="btn btn-lg btn-primary"
										onclick="location.href='<%=gc%>/member/update'">UPDATE</button>
									<button type="button" class="btn btn-lg btn-primary"
										onclick="location.href='<%=gc%>/mainHome'">MAIN</button>
								</div>
							</form>
						</div>
					</div>
