						...
						<div class="content-box wow bounceInDown modal-content">
							<h3 class="content-box-header content-box-header-alt bg-default">
								<span class="icon-separator"> <i
									class="glyph-icon icon-cog"></i>
								</span> <span class="header-wrapper"> WELCOME TO ECO COFFEE <small>Login
										your account.</small>
								</span> <span class="header-buttons"> <a href="join"
