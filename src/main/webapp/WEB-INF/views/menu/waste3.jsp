...
<title>ECO COFFEE - COFFEE WASTE</title>
		...
		<div class="row">
				...
				<div class="blog-box blog-box-alt row">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							...
							data-original="../resources/assets/image-resources/stock-images/img-20.jpg">
					</div>
					<div class="post-content">
						<p>한국소비자원은 소비자 1000명을 대상으로 시장점유율 상위 7개
							커피전문점(스타벅스·엔제리너스·탐앤탐스·투썸플레이스·할리스커피·커피빈·이디야 커피)에 대한 소비자 만족도를 조사한
							결과 스타벅스가 종합만족도 5점 만점에 3.83점으로 1위를 차지했다고 2017년 7월 21일에 밝혔다.</p>
						<p>스타벅스는 총 6개로 이뤄진 평가항목(직원 서비스·접근성·매장이용 편리성·메뉴·가격·호감도) 가운데 △직원
							서비스 △접근성 △메뉴 △호감도에서 가장 높은 평가를 받았다.</p>
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
						<a class="post-title">
							<h4>'2017, 서울, 꽃으로 피다' 친환경 캠페인 5년 연속 개최</h4>
						</a><br>
					</div>
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 50%; height: 50%;"
							data-original="../resources/assets/image-resources/stock-images/img-19.jpg">
					</div>
					<div class="post-content">
						<p>스타벅스커피 코리아가 2017년 9월 18일 서울광장에서 개최하는 연중 도시 녹화 캠페인 '서울, 꽃으로
							피다'에 5년 연속 동참하며 다회용컵 이용과 커피찌꺼기 자원 재활용을 주제로 시민 5000명에게 텀블러와 커피퇴비로
							만든 꽃 화분 등을 증정했다.</p>
						<p>11시부터 스타벅스, 서울시, 자원순환사회연대 임직원들이 참여하는 오픈 기념식을 시작으로, 11시30분부터
							고객 체험 행사를 진행한다. 다회용 컵 사용 또는 꽃과 함께 찍은 친환경 활동 사진 인증, 환경 지킴이 동참 서명
							SNS 공유, 커피찌꺼기 자원 선순환 전시 관람 등의 체험 순서를 마치면 커피 퇴비로 심은 7종 꽃 화분 또는 키트를
							비롯해 스타벅스 텀블러를 각각 5000개씩 1인 1회 한정으로 선착순 증정했다.</p>
						<p>스타벅스는 대나무 울타리와 꽃 화분으로 조성한 9미터 길이 도심 속 꽃 길을 조성하고 아메리카노 커피
							5만잔 분량 커피찌꺼기를 재활용한 가로 2미터, 세로 2미터 크기의 대형 사이렌 아트 조형물을 비롯해, 농가 지원
							자원 선순환 전시물 등을 선보이며 환경 보호 실천 메시지를 전달했다.</p>
						<p>또한, 서울광장을 찾은 5000명 시민들에게 특별한 즐거움을 전달하기 위해 벤치와 파라솔, 꽃 화분으로
							꾸민 기념 포토 공간을 마련하고 마임과 풍선 퍼포먼스와 시민청 활력콘서트 버스킹 공연도 진행했다.</p>
						<p>스타벅스는 2013년부터 올해까지 5년 연속 서울시의 연중 캠페인 '서울, 꽃으로 피다'에 동참하며
							일회용컵의 사용을 줄이고 생활 속에서 커피찌꺼기를 통해 실천할 수 있는 자원 선순환 친환경 활동을 알리는 소개해 오고
							있다.</p>
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							...
							data-original="../resources/assets/image-resources/stock-images/img-22.jpg">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div>
						<video width="70%" style="margin : 0 auto; display : block;"
							controls> <source src="../resources/video/1.mp4"
							type="video/mp4"> <source src="../resources/video/1.ogg"
							type="video/ogg"> Your browser does not support the
						video tag. </video>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="list-group mrg20B">
					<a href="<%=gc%>/menu/waste" class="list-group-item"> <i
						class="glyph-icon font-red icon-bullhorn"></i> 커피박 <i
						class="glyph-icon font-green icon-chevron-right"></i>
					</a> <a href="<%=gc%>/menu/waste2" class="list-group-item"> <i
						class="glyph-icon font-red icon-bullhorn"></i> 커피박 활용법 <i
						class="glyph-icon font-green icon-chevron-right"></i>
					</a> <a href="<%=gc%>/menu/waste3" class="list-group-item"> <i
						class="glyph-icon font-red icon-bullhorn"></i> STARBUCKS 커피박 활용 <i
						class="glyph-icon font-green icon-chevron-right"></i>
					</a>
				</div>
				<div class="content-box">
					...
					<div class="content-box-wrapper clearfix tags-list">
						<a
							href="https://www.instagram.com/explore/tags/%EC%BB%A4%ED%94%BC%EB%B0%95/?hl=ko"
							target="_blank" class="bs-label label-black">#커피박</a> <a
							href="https://www.instagram.com/explore/tags/%EC%BB%A4%ED%94%BC%EC%B0%8C%EA%BA%BC%EA%B8%B0/?hl=ko"
							target="_blank" class="bs-label label-warning">#커피찌꺼기</a> <a
							href="https://www.instagram.com/explore/tags/%EC%BB%A4%ED%94%BC%EC%B0%8C%EA%BA%BC%EA%B8%B0%EC%9E%AC%ED%99%9C%EC%9A%A9/?hl=ko"
							target="_blank" class="bs-label label-success">#커피찌꺼기재활용</a>
					</div>
				</div>
			</div>
		</div>
