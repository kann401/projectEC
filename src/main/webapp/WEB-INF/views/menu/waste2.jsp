		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="blog-box blog-box-alt row">
					...
					<div>
						<video width="70%" autoplay
							...
							src="../resources/video/2.mp4" type="video/mp4"> <source
							src="../resources/video/2.ogg" type="video/ogg"> Your
				...
				<div class="blog-box blog-box-alt row">
					...
					<div>
						<video width="70%" style="margin : 0 auto; display : block;"
							controls> <source src="../resources/video/3.mp4"
							type="video/mp4"> <source src="../resources/video/3.ogg"
									...
									<div class="panel-layout">
										<div class="panel-box">
											<div class="panel-content image-box">
												<img
													src="../resources/assets/image-resources/stock-images/img-29.JPG"
													style="width: 100%;">
											</div>
										</div>
									</div>
								...
								<div class="col-md-4">
									<div class="panel-layout">
										<div class="panel-box">
											<div class="panel-content image-box">
												<img
													src="../resources/assets/image-resources/stock-images/img-30.JPG"
													style="width: 100%;">
											</div>
										</div>
									</div>
								...
								<div class="col-md-4">
									<div class="panel-layout">
										<div class="panel-box">
											<div class="panel-content image-box">
												<img
													src="../resources/assets/image-resources/stock-images/img-31.JPG"
													style="width: 100%;">
											</div>
										</div>
									</div>
				...
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
						<a class="post-title">
							<h4>커피박 퇴비 제조 및 활용 매뉴얼</h4>
						</a><br>
					</div>
					<div class="post-image col-md-4">
						<img class="img-responsive"
							src="../resources/assets/image-resources/stock-images/img-32.jpg">
					</div>
					<div class="post-content-wrapper col-md-8">
						<div class="post-content">
							<p>▶ 커피박 개요, 커피박 퇴비 만들기, 커피박 퇴비의 특성,</p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;생활 속의 커피박 활용 방법, 참고문헌 등 총 5장으로 구성</p>
							<p>▶ 배부처 : 각 도 농업기술원, 시·군 농업기술센터, 소비자단체 등</p>
							<p>▶ PDF 자료 다운 : 농진청 농업과학도서관 누리집(lib.rda.go.kr)</p>
						</div>
					</div>
				</div>
			</div>
