		...
		<div class="row">
					...
					<div class="post-content-wrapper">
						<div class="post-image">
							<img class="img-responsive lazy"
								...
								data-original="../resources/assets/image-resources/stock-images/img-23.JPG">
						</div>
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
						<div class="post-image">
							<img class="img-responsive lazy"
								style="margin: 0 auto; width: 50%; height: 50%;"
								data-original="../resources/assets/image-resources/stock-images/img-24.JPG">
						</div>
					</div>
				</div>
			...
			<div class="col-md-3">
				<div class="list-group mrg20B">
					<a href="<%=gc%>/menu/waste2" class="list-group-item"> <i
