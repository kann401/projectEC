				...
				<div class="blog-box blog-box-alt row">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							...
							data-original="../resources/assets/image-resources/stock-images/img-04.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-05.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-06.JPG">
					</div>
				</div>
			</div>
			<div class="col-md-3">
