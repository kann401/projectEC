				...
				<div class="blog-box blog-box-alt row">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							...
							data-original="../resources/assets/image-resources/stock-images/img-16.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-17.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-18.JPG">
					</div>
				</div>
			</div>
			<div class="col-md-3">
