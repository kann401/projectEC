...
<title>ECO COFFEE - INTRODUCE</title>
							...
							<div class="panel-layout">
								<div class="panel-box">
									<div class="panel-content image-box">
										<img
											src="../resources/assets/image-resources/stock-images/img-52.jpg"
											style="width: 100%;">
									</div>
									<div class="panel-content bg-white">
										<i class="glyph-icon font-red icon-bullhorn"></i>&nbsp;&nbsp;KIM
										WOO SUNG
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-4">
							<div class="panel-layout">
								<div class="panel-box">
									<div class="panel-content image-box">
										<img
											src="../resources/assets/image-resources/stock-images/img-53.jpg"
											style="width: 100%;">
									</div>
									<div class="panel-content bg-white">
										<i class="glyph-icon font-red icon-bullhorn"></i>&nbsp;KIM
						...
						<div class="col-lg-3 col-md-4">
							<div class="panel-layout">
								<div class="panel-box">
									...
									<div class="panel-content bg-white">
										<i class="glyph-icon font-red icon-bullhorn"></i>&nbsp;&nbsp;WOO
										JONG WAN
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-4">
							<div class="panel-layout">
								<div class="panel-box">
									...
									<div class="panel-content bg-white">
										<i class="glyph-icon font-red icon-bullhorn"></i>&nbsp;&nbsp;AHN
										HYUN TAE
									</div>
								</div>
							</div>
		...
		<div class="owl-carousel-1 slider-wrapper carousel-wrapper">
			...
			<div>
				<div class="thumbnail-box">
					...
					<img
						src="../resources/assets/image-resources/stock-images/img-33.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-34.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-35.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-36.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-37.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-38.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-39.JPG">
				</div>
			</div>
			<div>
				<div class="thumbnail-box">
					<div class="thumb-overlay"></div>
					<img
						src="../resources/assets/image-resources/stock-images/img-40.JPG">
				</div>
			</div>
