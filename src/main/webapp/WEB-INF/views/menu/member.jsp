		...
		<div class="row">
							...
							<c:forEach items="${mlist}" var="mlist">
								<div class="example-box-wrapper">
									<table class="table">
										...
										<tbody>
											<tr>
												<td style="text-align: center">${mlist.custid}</td>
												<td style="text-align: center">${mlist.name}</td>
												<td style="text-align: center">${mlist.tel}</td>
												<td style="text-align: center">${mlist.road}</td>
											</tr>
										</tbody>
									</table>
								</div>
			...
			<c:if test="${division == 'business'}">
				<div class="col-md-6">
					<div class="panel">
						<div class="panel-body">
							<h3 class="title-hero">PICKUP COMPANY</h3>
							<div class="example-box-wrapper">
								<table class="table">
									<thead>
										<tr>
									...
									<tbody>
										<tr>
											<td style="text-align: center">${member.custid}</td>
											<td style="text-align: center">${member.name}</td>
											<td style="text-align: center">${member.tel}</td>
											<td style="text-align: center">${member.road}</td>
										</tr>
									</tbody>
								</table>
							</div>
