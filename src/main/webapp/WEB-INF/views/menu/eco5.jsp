				...
				<div class="blog-box blog-box-alt row">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							...
							data-original="../resources/assets/image-resources/stock-images/img-10.JPG">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-11.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-12.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-13.JPG">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-14.JPG">
					</div>
				</div>
				<div class="blog-box blog-box-alt row">
					<div class="post-content-wrapper">
					...
					<div class="post-image">
						<img class="img-responsive lazy"
							style="margin: 0 auto; width: 90%; height: 90%;"
							data-original="../resources/assets/image-resources/stock-images/img-15.JPG">
					</div>
				</div>
			</div>
			<div class="col-md-3">
				...
				<div class="list-group mrg20B">
					<a href="<%=gc%>/menu/eco1" class="list-group-item"> <i
