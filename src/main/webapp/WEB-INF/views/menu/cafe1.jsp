...
<%-- 각 지점 이미지 클릭시에 밑에 추가될 상세페이지를 불러오는 함수--%>
	function opendetail1() {
		...
		detail1 += '<h3 class="p-title"><span>STARBUCKS</span></h3>';
		detail1 += '<p style = "text-align: center;">홈메이드 스타일의 전용 푸드와 스타벅스 커피를 만나보세요.<br><br></p>';
		...
		detail1 += '<img src="../resources/image/star_cheongdam_1.jpg"></div></div></div></div>';
		detail1 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail1 += '<img src="../resources/image/star_cheongdam_2.jpg"></div></div></div></div>';
		detail1 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail1 += '<img src="../resources/image/star_cheongdam_3.jpg"></div></div></div></div>';
		detail1 += '</div></div></div>';
	...
	function opendetail2() {
		...
		detail2 += '<h3 class="p-title"><span>COFFEEBEAN</span></h3>';
		detail2 += '<p style = "text-align: center;">커피빈의 다양한 푸드와 커피를 만나보세요.<br><br></p>';
		...
		detail2 += '<img src="../resources/image/img-28.JPG"></div></div></div></div>';
		detail2 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail2 += '<img src="../resources/image/img-29.JPG"></div></div></div></div>';
		detail2 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail2 += '<img src="../resources/image/img-30.JPG"></div></div></div></div>';
		detail2 += '</div></div></div>';
	...
	function opendetail3() {
		...
		detail3 += '<h3 class="p-title"><span>A TWOSOME PLACE</span></h3>';
		detail3 += '<p style = "text-align: center;">다양한 케이크와 투썸플레이스 커피를 만나보세요.<br><br></p>';
		...
		detail3 += '<img src="../resources/image/img-07.JPG"></div></div></div></div>';
		detail3 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail3 += '<img src="../resources/image/img-08.JPG"></div></div></div></div>';
		detail3 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail3 += '<img src="../resources/image/img-09.JPG"></div></div></div></div>';
		detail3 += '</div></div></div>';
	...
	function opendetail4() {
		...
		detail4 += '<h3 class="p-title"><span>ANGEL-IN-US COFFEE</span></h3>';
		detail4 += '<p style = "text-align: center;">차별화된 푸드와 엔제리너스의 커피를 만나보세요.<br><br></p>';
		...
		detail4 += '<img src="../resources/image/img-10.JPG"></div></div></div></div>';
		detail4 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail4 += '<img src="../resources/image/img-11.JPG"></div></div></div></div>';
		detail4 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail4 += '<img src="../resources/image/img-12.JPG"></div></div></div></div>';
		detail4 += '</div></div></div>';
	...
	function opendetail5() {
		...
		detail5 += '<h3 class="p-title"><span>HOLLYS COFFEE</span></h3>';
		detail5 += '<p style = "text-align: center;">다양한 푸드와 할리스 커피를 만나보세요.<br><br></p>';
		...
		detail5 += '<img src="../resources/image/hollys_naru_1.jpg"></div></div></div></div>';
		detail5 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail5 += '<img src="../resources/image/hollys_naru_2.jpg"></div></div></div></div>';
		detail5 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail5 += '<img src="../resources/image/hollys_naru_3.jpg"></div></div></div></div>';
		detail5 += '</div></div></div>';
	...
	function opendetail6() {
		...
		detail6 += '<h3 class="p-title"><span>TOM N TOMS</span></h3>';
		detail6 += '<p style = "text-align: center;">다양한 푸드와 탐앤탐스의 커피를 만나보세요.<br><br></p>';
		...
		detail6 += '<img src="../resources/image/img-13.JPG"></div></div></div></div>';
		detail6 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail6 += '<img src="../resources/image/img-14.JPG"></div></div></div></div>';
		detail6 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail6 += '<img src="../resources/image/img-15.JPG"></div></div></div></div>';
		detail6 += '</div></div></div>';
	...
	function opendetail7() {
		...
		detail7 += '<h3 class="p-title"><span>EDIYA COFFEE</span></h3>';
		detail7 += '<p style = "text-align: center;">다양한 이디야의 커피와 음료를 만나보세요.<br><br></p>';
		...
		detail7 += '<img src="../resources/image/img-16.JPG"></div></div></div></div>';
		detail7 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail7 += '<img src="../resources/image/img-17.JPG"></div></div></div></div>';
		detail7 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail7 += '<img src="../resources/image/img-18.JPG"></div></div></div></div>';
		detail7 += '</div></div></div>';
	...
	function opendetail8() {
		...
		detail8 += '<h3 class="p-title"><span>빽다방</span></h3>';
		detail8 += '<p style = "text-align: center;">다양한 빽다방의 음료를 만나보세요.<br><br></p>';
		...
		detail8 += '<img src="../resources/image/img-19.JPG"></div></div></div></div>';
		detail8 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail8 += '<img src="../resources/image/img-20.JPG"></div></div></div></div>';
		detail8 += '<div class="owl-item" style="width: 250px;"><div><div class="thumbnail-box-wrapper mrg5A"><div class="thumbnail-box">';
		detail8 += '<img src="../resources/image/img-21.JPG"></div></div></div></div>';
		detail8 += '</div></div></div>';
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<img src="../resources/image/star.jpg"
							style="width: 62%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
							<a href="javascript:opendetail1()"> <!-- href 수정 -->
								Starbucks
							</a>
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/bean.jpg"
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/twosome.jpg"
							style="width: 64%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
							<a href="javascript:opendetail3()"> <!-- href 수정 --> A TWOSOME PLACE
							</a>
							<!-- 위의 css 처리는 현 페이지에서 처리했음. -->
						</h3>
					</div>
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/angel.jpg"
							style="width: 62%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/hollys.jpg"
							style="width: 62%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
							<a href="javascript:opendetail5()"> <!-- href 수정 --> Hollys
								Coffee
							</a>
							<!-- 위의 css 처리는 현 페이지에서 처리했음. -->
						</h3>
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/tom.jpg"
							style="width: 67%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
							<a href="javascript:opendetail6()"> <!-- href 수정 --> TOM N
								TOMS
							</a>
							<!-- 위의 css 처리는 현 페이지에서 처리했음. -->
						</h3>
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/ediya.JPG"
							style="width: 68%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
							<a href="javascript:opendetail7()"> <!-- href 수정 --> EDIYA
								COFFEE
							</a>
							<!-- 위의 css 처리는 현 페이지에서 처리했음. -->
						</h3>
			...
			<div>
				<div class="thumbnail-box-wrapper mrg5A">
					<div class="thumbnail-box">
						...
						<div class="thumb-overlay"></div>
						<img src="../resources/image/paik.JPG"
							style="width: 70%; margin-left: auto; margin-right: auto; display: block;">
					</div>
					<div class="thumb-pane">
						<h3 class="thumb-heading animated rollIn">
							<a href="javascript:opendetail8()"> <!-- href 수정 --> 빽다방
							</a>
							<!-- 위의 css 처리는 현 페이지에서 처리했음. -->
						</h3>
					</div>
