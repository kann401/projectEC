...
<title>ECO COFFEE - PICKUP COMPANY</title>
    ...
    $(document).ready(
        function() {
            var map = new daum.maps.Map(document.getElementById('map-cluster'), { // 지도를 표시할 div
                center: new daum.maps.LatLng(37.5395964296765, 127.049926038334), // 지도의 중심좌표 
                level: 8 // 지도의 확대 레벨 
            });
                        ...
                        daum.maps.event
                            .addListener(
                                ...
                                function() {
                                    ...
                                    var level = map
                                        .getLevel() - 1; // 지도를 클릭된 클러스터의 마커의 위치를 기준으로 확대합니다
                                    map.setLevel(
                                        level, {
