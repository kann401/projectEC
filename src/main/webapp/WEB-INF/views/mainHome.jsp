...
<!-- 로그인 한게 카페인지, 업체인지에 따라서 다르게 처리. -->
<c:if test="${division == 'business'}">
	<!-- 업체로 로그인시 쪽지 인클루드 -->
	<%@ include file="./message/busialarm.jsp"%>
</c:if>
<c:if test="${division == 'cafe'}">
	<!-- 카페로 로그인시 쪽지 인클루드 -->
	<%@ include file="./message/cafealarm.jsp"%>
</c:if>
...
<link href="./resources/css/stylesheet.css" media="screen"
...
<body>
	...
	<!-- 로그인 후 서버에서의 오류로 현재 페이지로 되돌아온 경우 오류 메시지를 출력 -->
	...
	<div class="main-header bg-header wow fadeInDown">
		<div class="container">
			...
			<ul class="header-nav collapse">
				...
				<li><a href="#"> CAFE <i class="glyph-icon icon-angle-down"></i>
				</a>
					<ul>
						<li><a href="<%=gc%>/menu/cafe1"><span>FRANCHISE
									CAFE</span></a></li>
				...
				<li><a href="#"> RESERVATION <i
					...
					<ul>
						...
						<li><a href="<%=gc%>/menu/confirm"><span>RESULT
									CONFIRM</span></a></li>
					</ul></li>
	...
	<div class="large-padding pad25B">
		<div class="container pad25B row">
			...
			<div class="col-md-4">
				<div
					class="icon-box icon-box-offset-large bg-default content-box icon-boxed">
					<span><img src="./resources/image/coff.jpg"
						style="width: 90%; height: 30%"></span>
					<div
						style="margin-top: 10px; margin-bottom: 0; px; text-align: float: none; margin: 0 auto; text-align: center;">

						<div
							style="font-size: 32px; float: none; margin: 0 auto; text-align: center;">140
							ton</div>

						<p>
							<span style="font-size: 13px;"><strong>Amount of
									Wasted Coffee in SEOUL (1 DAY)<br />
							</strong></span>
						</p>
			...
			<div class="col-md-4">
				<div
					class="icon-box icon-box-offset-large bg-default content-box icon-boxed"
					align="center">
					<div id="morrisChart1" style="height: 207px; align: center">
			...
			<div class="col-md-4">
				<div
					class="icon-box icon-box-offset-large bg-default content-box icon-boxed">
					<div>
						<video width="95%" height="30%" autoplay
							style="margin : 0 auto; display : block;" controls> <source
							src="./resources/video/5.mp4" type="video/mp4"> <source
							src="./resources/video/5.ogg" type="video/ogg"> Your
	...
	<div class="main-footer bg-gradient-4 clearfix">
		...
		<div class="container clearfix">
			...
			<div class="insta_area">
				...
				<ul>
					<li><a href="https://www.instagram.com/p/BYKA6dWDK-_/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/20987225_1489388197789464_3058665911943692288_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQRLn3jCyx/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21827321_166213137265478_1913923158939795456_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQS1KyjC1S/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/20766468_1966629553625681_2838126015673270272_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQTj5ED_kU/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21879385_119481592088306_2258250493786587136_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQT2rTjdre/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21879485_159282414654858_6472916182117646336_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQVd2aDvgE/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21820355_122085191846238_4841855643692302336_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQYiY4DqqH/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21909935_236828580176424_965476186777976832_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQYnvfDlZO/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21819723_495529827472042_3495715272814231552_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQYu7PD9jo/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21819748_518422268504174_899800944206675968_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQY2i9jxw6/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21827164_281018322304484_5362795147601903616_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQY-5sj0ls/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21819874_173374623222389_4427970325644312576_n.jpg">
					</a></li>
					<li><a href="https://www.instagram.com/p/BZQZFryDVeR/"
						target="_blank"> <img
							src="https://scontent-hkg3-1.cdninstagram.com/t51.2885-15/e35/21879011_117806175575754_6220471344627187712_n.jpg">
					</a></li>
				</ul>
				<div style="height: 15px; width: 100%;"></div>
				<a href="https://www.instagram.com/coffeerecycle/" class="btn"
					target="_blank">OUR INSTAGRAM - @coffeerecycle</a>
			</div>
