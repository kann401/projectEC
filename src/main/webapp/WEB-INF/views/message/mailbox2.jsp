		...
		<c:if test="${division == 'business'}">
			...
			<div class="row">
				...
				<div class="row mailbox-wrapper">
					...
					<c:forEach items="${forcontent}" var="contentlist">
						<div class="col-md-9">
							<div class="panel">
								<div class="panel-body">
									<h3 class="title-hero" align="center">
										${contentlist.cafename}에서 배출 요청이 도착했습니다.</h3>
									<div class="example-box-wrapper">
										<form class="form-horizontal bordered-row">
											<div class="form-group" align="center">
												<label class="col-sm-3 control-label">RESERVATION
													DATE</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" readonly="readonly"
														value="${contentlist.reserDate}" />
												</div>
											</div>
											<div class="form-group" align="center">
												<label class="col-sm-3 control-label">RESERVATION
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" readonly="readonly"
														value="${contentlist.reserTime}" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label">REQUESTING
													CAFE</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" readonly="readonly"
														value="${contentlist.cafename}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label">CAFE TEL</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" readonly="readonly"
														value="${contentlist.cafetel}">
												</div>
											</div>
										</form>

										<form method="POST" action="msgchanget"
											id="msgchanget${contentlist.resernum}">
											<input type="hidden" name="resernum"
												value="${contentlist.resernum}">
										</form>

										<form method="POST" action="msgchangef"
											id="msgchangef${contentlist.resernum}">
											<input type="hidden" name="resernum"
												value="${contentlist.resernum}">
										</form>
										...
										<div class="form-group" align="center">
											...
											<c:if test="${contentlist.msg =='d'}">
												<a href="#"
													onclick="document.getElementById('msgchanget${contentlist.resernum}').submit();"
													class="btn btn-blue-alt" title="Reply"> <i
													class="glyph-icon icon-check-circle-o"></i> AGREE <!-- 수락을 누르게 되면 msg컬럼이 t로 바뀌고 카페측에 수락 메시지 전달. -->
												</a>
        
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#"
													onclick="document.getElementById('msgchangef${contentlist.resernum}').submit();"
													class="btn btn-danger" title="Reply"> <i
													class="glyph-icon icon-times-circle-o"></i> REJECT <!-- 거절을 누르게 되면 msg컬럼이 f로 바뀌고 카페측에 거부 메시지 전달. -->
												</a>
											</c:if>

											<c:if test="${contentlist.msg =='t'}">
             &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" onclick="location.href='mailbox1'"
													class="btn btn-danger" title="Reply"> <i
													class="glyph-icon icon-times-circle-o"></i> BACK <!-- 거절을 누르게 되면 msg컬럼이 f로 바뀌고 카페측에 거부 메시지 전달. -->
												</a>
											</c:if>
			...
			<div class="row">
				...
				<div class="row mailbox-wrapper">
					...
					<div class="col-md-9">
						<div class="panel">
							<div class="panel-body">
								<c:if test="${list.msg == 't' }">
									<h4 class="title-hero" align="center">${list.businessname}에서
										배출 요청을 수락했습니다.</h4>
								</c:if>

								<c:if test="${list.msg == 'f' }">
									<h4 class="title-hero" align="center">${list.businessname}에서
										배출 요청을 거절했습니다.</h4>
								</c:if>

								<c:if test="${list.msg == 'e' }">
									<h4 class="title-hero" align="center">${list.businessname}와의
										수거/배출이 완료 되었습니다.</h4>
								</c:if>
								<div class="example-box-wrapper">
									<form class="form-horizontal bordered-row">
										...
										<div class="form-group" align="center">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" readonly="readonly"
													value="${list.reserTime}" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">PICKUP COMPANY
												NAME</label>
											<div class="col-sm-6">
												<input type="text" class="form-control" readonly="readonly"
													value="${list.businessname}">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">PICKUP COMPANY
									...
									<div class="form-group" align="center">
										...
										<c:if test="${contentlist.msg =='t'}">
             &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" onclick="location.href='notreadmsg'"
												class="btn btn-danger" title="Reply"> <i
												class="glyph-icon icon-times-circle-o"></i> BACK
											</a>
										</c:if>
