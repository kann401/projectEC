...
<title>ECO COFFEE - RESERVATION CONFIRM</title>
...
<script>
	function reserdelete(){
		if(confirm("Do you want to cancel your reservation?")){
			location.href='http://10.10.8.18:8888/projectEC/menu/reserdelete?resernum=${reserconfirm.resernum}'
			/* location.href='http://localhost:8888/projectEC/menu/reserdelete?resernum=${reserconfirm.resernum}' */
		}
	}
</script>
</head>
			...
			<div style="width: 1000px; background: white;">
				...
				<div class="panel">
					<div class="panel-body">
						<h3 class="title-hero">Please Confirm Your Reservation!</h3>
						<div class="example-box-wrapper">
							<form id="updateform" action="update"
								class="form-horizontal bordered-row" method="post"
								onsubmit="return formCheck();">
								<div class="form-group">
									<label class="col-sm-3 control-label">CAFE NAME</label>
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="cafename" name="cafename" readonly="readonly"
											value="${reserconfirm.cafename}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="cafetel" name="cafetel" readonly="readonly"
											value="${reserconfirm.cafetel}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="businessname" name="businessname" readonly="readonly"
											value="${reserconfirm.businessname}">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">PICKUP COMPANY
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="businesstel" name="businesstel" readonly="readonly"
											value="${reserconfirm.businesstel}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="reserDate" name="reserDate" readonly="readonly"
											value="${reserconfirm.reserDate}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="reserTime" name="reserTime" readonly="readonly"
											value="${reserconfirm.reserTime}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control popover-button-default"
											id="msg" name="msg" readonly="readonly" value="${msg}">
									</div>
								</div>
								<div class="form-group">
									<div>
										<c:if test="${reserconfirm.msg=='d'}">
											<button type="button"
												class="btn btn-default btn-lg btn-block btn-border border-green btn-block"
												onclick=reserdelete();>DELETE</button>
										</c:if>
										<button type="button"
											class="btn btn-default btn-lg btn-block btn-border border-green btn-block"
											onclick="location.href='<%=cp%>/menu/schedule'">BACK</button>
									</div>
								</div>
