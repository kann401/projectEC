...
<title>ECO COFFEE - CAFE GRAPH</title>
...
function graph3() {
   ...
   var list9 = ${alllist9};
      ...
      new Morris.Line({
        ...
        //x축의 값이 4개일 경우 깨진다.
        data: [
          { year: '201707', value: list5 },
          { year: '201708', value: list6 },
          { year: '201709', value: list7 },
          { year: '201710', value: list8 },
          { year: '201711', value: list9 },
        ],
...
<body>
   ...
   <!-- code here  -->
   <c:if test="${loginId != null && division == 'cafe' && list5 != null}">
   <script type="text/javascript">
...
$(window).load(function () { 
   ...
   <!-- code here  -->
   <div align = center><h3>[ MY WASTED COFFEE AMOUNT ]</h3></div><br>
   <div id="morrisChart2" style="weight: 200px; height: 250px;"></div><br><br>
   </c:if>
   <div align = center><h3>[ TOTAL WASTED COFFEE AMOUNT ]</h3></div><br>
   <div id="morrisChart3" style="weight: 200px; height: 250px;"></div>
   <!-- /code here -->
   </div>
   <h3 class="p-title"></h3>
	</div>
