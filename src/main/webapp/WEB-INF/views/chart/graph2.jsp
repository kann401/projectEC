...
<title>ECO COFFEE - PICKUP COMPANY GRAPH</title>
...
<body>
   ...
   <div id = row>
   <c:if test="${loginId != null && division == 'business' && list5 != null}">
   <script type="text/javascript">
   $(window).load(function () { 
         graph2();
   });
   ...
   <div align = center><h3>[ MY PICKUP AMOUNT ]</h3></div><br>
   <div id="morrisChart2" style="weight: 200px; height: 250px;"></div><br><br>
   </c:if>
   <div align = center><h3>[ TOTAL PICKUP AMOUNT ]</h3></div><br>
