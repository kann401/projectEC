    ...
    function BasicView(element, calendar, viewName) {
        ...
        function buildCellHTML(date) { // date assumed to have stripped time
            ...
            html +=
                ...
                ">" +
                "<div>";
            var year = t.intervalStart.year();
            var month = t.intervalStart.month()+1;
            var day = date.date();
            if (showNumbers) {
                html += "<div class='fc-day-number'>" +"<a onclick='schduleAdd("+year+","+month+","+day+")'>"+ day +"</a>"+ "</div>";
            }
            
            html +=
                "<div class='fc-day-content'><div class='content'></div>" +
