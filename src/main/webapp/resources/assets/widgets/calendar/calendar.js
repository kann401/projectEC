...
// Break the formatting string into an array of chunks
    ...
    function BasicView(element, calendar, viewName) {
        ...
        function buildCellHTML(date) { // date assumed to have stripped time
            ...
            var fyear = fulldate.substr(0,4);
            var fmonth = fulldate.substr(5,2);
            var fday = fulldate.substr(8,2);
            
            
            if (showNumbers) {
            	html += "<div class='fc-day-number'>" +"<a onclick='schduleAdd("+fyear+","+fmonth+","+fday+")'>"+ fday +"</a>"+ "</div>";
            }
